...
const Footer = () => {
  return (
    <footer className="w-full bg-cyan min-h-[50vh] grid justify-center text-dimWhite">

      <div className="xl:w-[1280px] flex flex-col justify-around px-2 lg:px-10">
        <div className="flex items-center justify-between border-b border-dotted border-white py-3">
          <h1 className="font-bold text-lg">Lets Connect Here</h1>
          <button className="button_neg textd-white p-1 md:p-2">
            <a href="/">Hire Me</a>
          </button>
        </div>
        ...
        <div className="flex justify-between font-light border-t border-dotted border-white py-2">
